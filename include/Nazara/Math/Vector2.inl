...
namespace Nz
{
	...
	*/
	...
	template<typename T>
	template<typename F>
	constexpr Vector2<T>& Vector2<T>::Apply(F&& func)
	{
		x = func(x);
		y = func(y);
	...
	*/
	template<typename T>
	bool Deserialize(SerializationContext& context, Vector2<T>* vector, TypeTag<Vector2<T>>)
	{
