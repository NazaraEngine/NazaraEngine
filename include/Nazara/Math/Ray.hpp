// Copyright (C) 2025 Gawaboumga (https://github.com/Gawaboumga) - Jérôme "SirLynix" Leclercq (lynix680@gmail.com)
...
namespace Nz
{
	...
	template<typename T> bool Deserialize(SerializationContext& context, Ray<T>* ray, TypeTag<Ray<T>>);
