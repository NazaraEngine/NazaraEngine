...
#ifndef NAZARA_AUDIO_AUDIOEFFECT_HPP
#define NAZARA_AUDIO_AUDIOEFFECT_HPP
...
namespace Nz
{
	...
	class NAZARA_AUDIO_API AudioDelayEffect final : public AudioNode
	{
		public:
			struct Config;
	...
	class NAZARA_AUDIO_API AudioReverbEffect final : public AudioNode
	{
		public:
			struct Config;
	...
	class NAZARA_AUDIO_API AudioSplitter final : public AudioNode
	{
		public:
			struct Config;
...
#include <Nazara/Audio/AudioEffect.inl>

#endif // NAZARA_AUDIO_AUDIOEFFECT_HPP
