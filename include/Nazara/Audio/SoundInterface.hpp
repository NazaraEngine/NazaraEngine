...
#ifndef NAZARA_AUDIO_SOUNDINTERFACE_HPP
#define NAZARA_AUDIO_SOUNDINTERFACE_HPP
...
namespace Nz
{
	...
	class NAZARA_AUDIO_API SoundInterface
	{
		public:
...
#include <Nazara/Audio/SoundInterface.inl>

#endif // NAZARA_AUDIO_SOUNDINTERFACE_HPP
