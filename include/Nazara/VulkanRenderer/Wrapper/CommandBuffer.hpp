...
namespace Nz::Vk
{
	class CommandBuffer
	{
		...
		public:
			...
			inline void BindDescriptorSet(VkPipelineBindPoint pipelineBindPoint, VkPipelineLayout layout, UInt32 firstSet, const VkDescriptorSet& descriptorSets, UInt32 dynamicOffsetCount, const UInt32* dynamicOffsets);
