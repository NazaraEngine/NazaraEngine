...
NAZARA_OPENGLRENDERER_FUNCTION(glClientWaitSync, PFNGLCLIENTWAITSYNCPROC)
...
NAZARA_OPENGLRENDERER_FUNCTION(glDeleteSync, PFNGLDELETESYNCPROC)
...
NAZARA_OPENGLRENDERER_FUNCTION(glFenceSync, PFNGLFENCESYNCPROC)
NAZARA_OPENGLRENDERER_FUNCTION(glFinish, PFNGLFINISHPROC)
NAZARA_OPENGLRENDERER_FUNCTION(glFlush, PFNGLFLUSHPROC)
NAZARA_OPENGLRENDERER_FUNCTION(glFlushMappedBufferRange, PFNGLFLUSHMAPPEDBUFFERRANGEPROC)
...
NAZARA_OPENGLRENDERER_FUNCTION(glGetSynciv, PFNGLGETSYNCIVPROC)
...
NAZARA_OPENGLRENDERER_FUNCTION(glWaitSync, PFNGLWAITSYNCPROC)

// Core OpenGL (doesn't exist in OpenGL ES)
NAZARA_OPENGLRENDERER_GL_FUNCTION(100, glGetTexImage, PFNGLGETTEXIMAGEPROC)
...
NAZARA_OPENGLRENDERER_GL_GLES_FUNCTION(400, 310, glDrawArraysIndirect, PFNGLDRAWARRAYSINDIRECTPROC)
NAZARA_OPENGLRENDERER_GL_GLES_FUNCTION(400, 310, glDrawElementsIndirect, PFNGLDRAWELEMENTSINDIRECTPROC)
...
NAZARA_OPENGLRENDERER_GL_GLES_FUNCTION(430, 320, glDebugMessageInsert, PFNGLDEBUGMESSAGEINSERTPROC)
...
// OpenGL 4.2 - GL_ARB_base_instance
NAZARA_OPENGLRENDERER_GL_FUNCTION(420, glDrawArraysInstancedBaseInstance, PFNGLDRAWARRAYSINSTANCEDBASEINSTANCEPROC)
NAZARA_OPENGLRENDERER_GL_FUNCTION(420, glDrawElementsInstancedBaseInstance, PFNGLDRAWELEMENTSINSTANCEDBASEINSTANCEPROC)
NAZARA_OPENGLRENDERER_GL_FUNCTION(420, glDrawElementsInstancedBaseVertexBaseInstance, PFNGLDRAWELEMENTSINSTANCEDBASEVERTEXBASEINSTANCEPROC)

// OpenGL 4.3 - GL_ARB_multi_draw_indirect
NAZARA_OPENGLRENDERER_GL_FUNCTION(430, glMultiDrawArraysIndirect, PFNGLMULTIDRAWARRAYSINDIRECTPROC)
NAZARA_OPENGLRENDERER_GL_FUNCTION(430, glMultiDrawElementsIndirect, PFNGLMULTIDRAWELEMENTSINDIRECTPROC)

// OpenGL 4.3 - GL_ARB_texture_view
NAZARA_OPENGLRENDERER_GL_FUNCTION(430, glTextureView, PFNGLTEXTUREVIEWPROC)

// OpenGL 4.4 - GL_ARB_buffer_storage/GL_EXT_buffer_storage
NAZARA_OPENGLRENDERER_GL_FUNCTION(440, glBufferStorage, PFNGLBUFFERSTORAGEPROC)
...
// OpenGL 4.3 - GL_ARB_indirect_parameters
NAZARA_OPENGLRENDERER_GL_FUNCTION(460, glMultiDrawArraysIndirectCount, PFNGLMULTIDRAWARRAYSINDIRECTCOUNTPROC)
NAZARA_OPENGLRENDERER_GL_FUNCTION(460, glMultiDrawElementsIndirectCount, PFNGLMULTIDRAWELEMENTSINDIRECTCOUNTPROC)
