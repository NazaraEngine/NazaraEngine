...
namespace Nz
{
	...
	inline std::optional<GLTextureFormat> DescribeTextureFormat(PixelFormat pixelFormat)
	{
		...
		switch (pixelFormat)
		{
			...
			case PixelFormat::BC5_Snorm:        return GLTextureFormat{ GL_COMPRESSED_SIGNED_RED_GREEN_RGTC2_EXT,  GL_RGBA, GL_UNSIGNED_BYTE,         GL_RED, GL_GREEN, GL_BLUE, GL_ALPHA };
			case PixelFormat::BC5_Unorm:        return GLTextureFormat{ GL_COMPRESSED_RED_GREEN_RGTC2_EXT,         GL_RGBA, GL_UNSIGNED_BYTE,         GL_RED, GL_GREEN, GL_BLUE, GL_ALPHA };
