...
#ifndef NAZARA_AUDIO2_AUDIOPROCESSOR_HPP
#define NAZARA_AUDIO2_AUDIOPROCESSOR_HPP
...
namespace Nz
{
	...
	class NAZARA_AUDIO2_API AudioProcessor : public AudioNode
	{
		public:
			struct Config;
...
#include <Nazara/Audio2/AudioProcessor.inl>

#endif // NAZARA_AUDIO2_AUDIOPROCESSOR_HPP
