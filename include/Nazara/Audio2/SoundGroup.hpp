...
#ifndef NAZARA_AUDIO2_SOUNDGROUP_HPP
#define NAZARA_AUDIO2_SOUNDGROUP_HPP
...
namespace Nz
{
	class NAZARA_AUDIO2_API SoundGroup final : public AudioNode, public SoundInterface
	{
		public:
			struct Config;
...
#include <Nazara/Audio2/SoundGroup.inl>

#endif // NAZARA_AUDIO2_SOUNDGROUP_HPP
