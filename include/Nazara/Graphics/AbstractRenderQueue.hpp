...
namespace Nz
{
	...
	class NAZARA_GRAPHICS_API AbstractRenderQueue
	{
		public:
			...
			virtual void AddMesh(int renderOrder, const Material* material, const MeshData& meshData, const Boxf& meshAABB, const Matrix4f& transformMatrix, std::size_t instanceIndex, const Recti& scissorRect) = 0;
