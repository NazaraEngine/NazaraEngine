...
namespace Nz
{
	inline bool NzPixelFormat::Convert(PixelFormatType srcFormat, PixelFormatType dstFormat, const void* src, void* dst)
	{
	...
	inline bool NzPixelFormat::Convert(PixelFormatType srcFormat, PixelFormatType dstFormat, const void* start, const void* end, void* dst)
	{
		if (srcFormat == dstFormat)
		{
	...
	inline bool NzPixelFormat::Flip(PixelFlipping flipping, PixelFormatType format, unsigned int width, unsigned int height, unsigned int depth, const void* src, void* dst)
	{
		#if NAZARA_UTILITY_SAFE
		if (!IsValid(format))
		{
	...
	inline UInt8 NzPixelFormat::GetBitsPerPixel(PixelFormatType format)
	{
		switch (format)
		{
	...
	inline UInt8 NzPixelFormat::GetBytesPerPixel(PixelFormatType format)
	{
		return GetBitsPerPixel(format)/8;
	}

	inline PixelFormatTypeType NzPixelFormat::GetType(PixelFormatType format)
	{
		switch (format)
		{
			case PixelFormatType_A8:
	...
	inline bool NzPixelFormat::HasAlpha(PixelFormatType format)
	{
		switch (format)
		{
			case PixelFormatType_A8:
	...
	inline bool NzPixelFormat::IsCompressed(PixelFormatType format)
	{
		switch (format)
		{
			case PixelFormatType_DXT1:
	...
	inline bool NzPixelFormat::IsConversionSupported(PixelFormatType srcFormat, PixelFormatType dstFormat)
	{
		if (srcFormat == dstFormat)
			return true;
	...
	inline bool NzPixelFormat::IsValid(PixelFormatType format)
	{
		return format != PixelFormatType_Undefined;
	}

	inline void NzPixelFormat::SetConvertFunction(PixelFormatType srcFormat, PixelFormatType dstFormat, ConvertFunction func)
	{
		s_convertFunctions[srcFormat][dstFormat] = func;
	}

	inline void NzPixelFormat::SetFlipFunction(PixelFlipping flipping, PixelFormatType format, FlipFunction func)
	{
		s_flipFunctions[flipping][format] = func;
	}

	inline String NzPixelFormat::ToString(PixelFormatType format)
	{
		switch (format)
		{
			case PixelFormatType_A8:
