...
namespace Nz
{
	...
	{
		// Réinitialisation
		std::memset(s_convertFunctions, 0, (PixelFormatType_Max+1)*(PixelFormatType_Max+1)*sizeof(NzPixelFormat::ConvertFunction));
	...
	*/
	...
	NzPixelFormat::ConvertFunction NzPixelFormat::s_convertFunctions[PixelFormatType_Max+1][PixelFormatType_Max+1];
	std::map<PixelFormatType, NzPixelFormat::FlipFunction> NzPixelFormat::s_flipFunctions[PixelFlipping_Max+1];
}
