...
namespace Nz
{
	...
	{
		constexpr EnumArray<Keyboard::Scancode, SDL_Scancode> s_scancodeMap = {
			// Lettres
			...
			// Touches de contrôle
			SDL_SCANCODE_MEDIA_EJECT,          // Key::Media_Eject
			SDL_SCANCODE_MEDIA_FAST_FORWARD,   // Key::Media_FastForward
			SDL_SCANCODE_MEDIA_NEXT_TRACK,     // Key::Media_Next
			SDL_SCANCODE_MEDIA_PLAY,           // Key::Media_Play
			SDL_SCANCODE_MEDIA_PREVIOUS_TRACK, // Key::Media_Previous
			SDL_SCANCODE_MEDIA_SELECT,         // Key::Media_Select
			SDL_SCANCODE_MEDIA_STOP,           // Key::Media_Stop
		...
		constexpr EnumArray<Keyboard::VKey, SDL_Keycode> s_virtualKeyMap = {
			// Keys
			SDLK_A,             // VKey::A
			SDLK_B,             // VKey::B
			SDLK_C,             // VKey::C
			...
			// Media control
			SDLK_MEDIA_EJECT,          // Key::Media_Eject
			SDLK_MEDIA_FAST_FORWARD,   // Key::Media_FastForward
			SDLK_MEDIA_NEXT_TRACK,     // Key::Media_Next
			SDLK_MEDIA_PLAY,           // Key::Media_Play
			SDLK_MEDIA_PREVIOUS_TRACK, // Key::Media_Previous
			SDLK_MEDIA_SELECT,         // Key::Media_Select
			SDLK_MEDIA_STOP,           // Key::Media_Stop
	...
	Keyboard::Scancode FromSDL(SDL_Scancode scancode)
	{
		switch (scancode)
		{
			...
			case SDL_SCANCODE_MEDIA_NEXT_TRACK:     return Keyboard::Scancode::Media_Next;
			case SDL_SCANCODE_MEDIA_PLAY:           return Keyboard::Scancode::Media_Play;
			case SDL_SCANCODE_MEDIA_PREVIOUS_TRACK: return Keyboard::Scancode::Media_Previous;
			case SDL_SCANCODE_MEDIA_STOP:           return Keyboard::Scancode::Media_Stop;
	...
	Keyboard::VKey FromSDL(SDL_Keycode keycode)
	{
		switch (keycode)
		{
			...
			case SDLK_MEDIA_NEXT_TRACK:     return Keyboard::VKey::Media_Next;
			case SDLK_MEDIA_PLAY:           return Keyboard::VKey::Media_Play;
			case SDLK_MEDIA_PREVIOUS_TRACK: return Keyboard::VKey::Media_Previous;
			case SDLK_MEDIA_STOP:           return Keyboard::VKey::Media_Stop;
			...
			case SDLK_GRAVE:                return Keyboard::VKey::Tilde;
			...
			case SDLK_APOSTROPHE:           return Keyboard::VKey::Quote;
	...
	SDL_Keycode ToSDL(Keyboard::VKey keycode)
	{
		...
		return s_virtualKeyMap[keycode];
	}
}
