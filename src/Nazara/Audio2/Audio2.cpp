...
namespace Nz
{
	...
	* \ingroup audio
	* \class Nz::Audio2
	* \brief Audio class that represents the module initializer of Audio2
	*/

	Audio2::Audio2(Config config) :
	...
	*/
	SoundBufferLoader& Audio2::GetSoundBufferLoader()
	{
	...
	*/
	const SoundBufferLoader& Audio2::GetSoundBufferLoader() const
	{
		return m_soundBufferLoader;
	}
	...
	*/
	SoundStreamLoader& Audio2::GetSoundStreamLoader()
	{
	...
	*/
	const SoundStreamLoader& Audio2::GetSoundStreamLoader() const
	{
		return m_soundStreamLoader;
	}
	...
	Audio2* Audio2::s_instance = nullptr;

	void Audio2::Config::Override(const CommandLineParameters& parameters)
	{
