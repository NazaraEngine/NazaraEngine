	...
	bool OpenGL::Initialize()
	{
		...
		*/
		...
		try
		{
			...
			glGetActiveUniformBlockiv = reinterpret_cast<PFNGLGETACTIVEUNIFORMBLOCKIVPROC>(LoadEntry("glGetActiveUniformBlockiv"));
			glGetActiveUniformBlockName = reinterpret_cast<PFNGLGETACTIVEUNIFORMBLOCKNAMEPROC>(LoadEntry("glGetActiveUniformBlockName"));
			...
			glGetUniformBlockIndex = reinterpret_cast<PFNGLGETUNIFORMBLOCKINDEXPROC>(LoadEntry("glGetUniformBlockIndex"));
			...
			glUniformBlockBinding = reinterpret_cast<PFNGLUNIFORMBLOCKBINDINGPROC>(LoadEntry("glUniformBlockBinding"));
