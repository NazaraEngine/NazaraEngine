...
#define NzValidateFeature(field, name) \
		...
		NzValidateFeature(drawBaseVertex, "draw base vertex feature")
		NzValidateFeature(drawIndirect, "draw indirect")
		NzValidateFeature(drawIndirectCount, "draw indirect with parameter count")
		NzValidateFeature(drawIndirectFirstInstance, "draw indirect with non-zero first instance")
		NzValidateFeature(multiDrawIndirect, "multi draw indirect")
		NzValidateFeature(nonSolidFaceFilling, "non-solid face filling feature")
		NzValidateFeature(persistentMapping, "persistent mapping support")
