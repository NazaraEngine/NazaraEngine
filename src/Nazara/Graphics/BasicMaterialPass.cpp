...
namespace Nz
{
	BasicMaterialPass::BasicMaterialPass(MaterialPass& material) :
	...
	float BasicMaterialPass::GetAlphaTestThreshold() const
	{
	...
	Color BasicMaterialPass::GetBaseColor() const
	{
	...
	void BasicMaterialPass::SetAlphaTestThreshold(float alphaThreshold)
	{
		NazaraAssert(HasAlphaTestThreshold(), "Material has no alpha threshold uniform");
	...
	void BasicMaterialPass::SetBaseColor(const Color& baseColor)
	{
		NazaraAssert(HasBaseColor(), "Material has no base color uniform");
	...
	MaterialSettings::Builder BasicMaterialPass::Build(BasicBuildOptions& options)
	{
	...
	std::vector<std::shared_ptr<UberShader>> BasicMaterialPass::BuildShaders()
	{
	...
	auto BasicMaterialPass::BuildUniformOffsets() -> std::pair<BasicUniformOffsets, nzsl::FieldOffsets>
	{
	...
	bool BasicMaterialPass::Initialize()
	{
	...
	void BasicMaterialPass::Uninitialize()
	{
		s_basicMaterialSettings.reset();
	}

	std::shared_ptr<MaterialSettings> BasicMaterialPass::s_basicMaterialSettings;
	std::size_t BasicMaterialPass::s_uniformBlockIndex;
	BasicMaterialPass::BasicOptionIndexes BasicMaterialPass::s_basicOptionIndexes;
	BasicMaterialPass::BasicTextureIndexes BasicMaterialPass::s_basicTextureIndexes;
	BasicMaterialPass::BasicUniformOffsets BasicMaterialPass::s_basicUniformOffsets;
}
