...
#undef NAZARA_OPENGLRENDERER_FUNC
		...
		if (glDebugMessageCallback && params.validationLevel != RenderAPIValidationLevel::None)
		{
			...
			glDebugMessageCallback([](GLenum source, GLenum type, GLuint id, GLenum severity, GLsizei length, const GLchar* message, const void* userParam) NAZARA_GL_CALLCONVENTION
			{
