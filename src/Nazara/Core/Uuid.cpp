...
#include <objbase.h>
#elif defined(NAZARA_PLATFORM_LINUX) || defined(NAZARA_PLATFORM_MACOS) || defined(NAZARA_PLATFORM_BSD) || defined(NAZARA_PLATFORM_ANDROID) || defined(NAZARA_PLATFORM_WEB)
#include <uuid/uuid.h>
#endif
