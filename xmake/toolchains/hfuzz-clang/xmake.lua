toolchain("hfuzz-clang")
    ...
    add_cxflags("-fsanitize=fuzzer")
    add_cxflags("-fprofile-instr-generate")
    add_cxflags("-fcoverage-mapping")
    add_ldflags("-fsanitize=fuzzer")
    add_shflags("-fsanitize=fuzzer")
    add_arflags("-fsanitize=fuzzer")
